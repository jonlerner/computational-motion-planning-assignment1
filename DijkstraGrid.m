...
while true
   ...
   % ********************************************************************* 
    ...
    visitNode(i-1, j, nrows, ncols, current, min_dist);
    visitNode(i+1, j, nrows, ncols, current, min_dist);
    visitNode(i, j-1, nrows, ncols, current, min_dist);
    visitNode(i, j+1, nrows, ncols, current, min_dist);
...
if (isinf(distanceFromStart(dest_node)))
    ...
    function visitNode(i, j, nrows, ncols, current, min_dist)
        ...
        % Add node to list
        if (distanceFromStart(node) > min_dist + 1)
            distanceFromStart(node) = min_dist + 1;
            parent(node) = current;
